...
\lstset{
  ...
  morekeywords=[1]{Name, String, Expr, NormalForm, NeutralForm, Env, Map, V, NeutralV, FreshName, State, Set, DbExpr, Int, Ty, Nat, Vec, Elem, OPE, NeutralExpr, NormalExpr, forall, SingTy, STy, Any, SingContext, 'BaseTy, Eq, ChurchNumeralTy, ChurchNumeral, NFData},
