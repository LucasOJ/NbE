...
\lstset{
  ...
  morekeywords=[1]{ctx, ty, arg, result, ctx1, ctx2, strong, weak, ctxV, ctx', ctxV', strongest, arg1, arg2, A, B},
  mathescape=true,
  keepspaces=true,
  aboveskip=10pt,
  belowskip=10pt,
...
\begin{enumerate}
    \item To produce various implementations of Normalisation by Evaluation in Haskell
...
\item Evaluate the practical use of the features enabled by compiler extensions, and recommend their use in instances where type-safety is the primary priority, see Chapter \ref{chap:evaluation}.
\end{itemize}
...
\noindent
Thanks also to the programming languages research group for listening to my presentation, and offering useful insights.
