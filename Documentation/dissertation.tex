...
\lstset{
  ...
  morekeywords=[1]{Name, String, Expr, NormalForm, NeutralForm, Env, Map, V, NeutralV, FreshName, State, Set, DbExpr, Int, Ty, Nat, Vec, Elem, OPE, NeutralExpr, NormalExpr, forall, SingTy, STy},
  morekeywords=[2]{Z, S, True, case, of},
  morekeywords=[3]{ctx, ty, arg, result, ctx1, ctx2, strong, weak, ctxV, ctx', ctxV'},
  mathescape=true,
  keepspaces=true,
  aboveskip=10pt,
  belowskip=10pt,
