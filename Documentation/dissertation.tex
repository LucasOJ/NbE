...
\lstset{
  ...
  morekeywords=[0]{data, where, type, class, instance, case, of, do, return},
  morekeywords=[1]{Name, String, Expr, NormalForm, NeutralForm, Env, Map, V, NeutralV, FreshName, State, Set, DbExpr, Int},
